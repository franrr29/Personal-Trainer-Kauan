...
import { createPayment, getPaymentsByStudentId, getPaymentById, createPublicPaymentController } from './payments.controller';

const router = Router();

//rota para criar um pagamento pelo treinador:
router.post('/public', createPublicPaymentController);
